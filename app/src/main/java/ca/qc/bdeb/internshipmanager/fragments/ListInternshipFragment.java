...
public class ListInternshipFragment extends Fragment {
    ...
    public static ListInternshipFragment newInstance(String param1, String param2) {
        ListInternshipFragment fragment = new ListInternshipFragment();
